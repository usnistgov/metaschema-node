...
export default class XmlFieldInstance extends AbstractFieldInstance {
    ...
    getDefinition() {
        const definition = this.getContainingDefinition()
            ...
            .getScopedFieldDefinitionByName(this.getName());
        if (definition) {
            return definition;
        }
    ...
    isInXmlWrapped(): boolean {
        // TODO: This needs to be implemented when adapters are implemented
